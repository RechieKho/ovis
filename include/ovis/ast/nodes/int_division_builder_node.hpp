#ifndef OVIS_AST_NODES_INT_DIVISION_BUILDER_NODE_HPP
#define OVIS_AST_NODES_INT_DIVISION_BUILDER_NODE_HPP
...
namespace ovis::ast
{
    ...
    namespace implementation
    {
        ...
        class int_division_builder_node final : public xint_binary_operation_builder_node<t_generator_type>
        {
        public:
        ...
        private:
        public:
            explicit int_division_builder_node(
            ...
            ~int_division_builder_node() override = default;
...
#endif // OVIS_AST_NODES_INT_DIVISION_BUILDER_NODE_HPP