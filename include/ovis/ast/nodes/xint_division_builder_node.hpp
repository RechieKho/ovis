#ifndef OVIS_AST_NODES_XINT_DIVISION_BUILDER_NODE_HPP
#define OVIS_AST_NODES_XINT_DIVISION_BUILDER_NODE_HPP
...
namespace ovis::ast
{
    ...
    namespace implementation
    {
        ...
        class xint_division_builder_node final : public xint_binary_operation_builder_node<t_generator_type>
        {
        public:
        ...
        private:
        public:
            explicit xint_division_builder_node(
            ...
            ~xint_division_builder_node() override = default;
...
#endif // OVIS_AST_NODES_XINT_DIVISION_BUILDER_NODE_HPP